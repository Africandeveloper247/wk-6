...
USE salesdb;       -- selecting database
...
SELECT p.productName, productVendor, productLine
FROM products p
...
SELECT o.orderDate, o.shippedDate, status, customerNumber
FROM orders o
RIGHT JOIN customers c ON o.customerNumber = c.customerNumber
LIMIT 10; -- first 10 orders
